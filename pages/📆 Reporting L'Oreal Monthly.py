...
#------------PAGE 2--------------
	...
	format_title(ppt.slides[page_no], "selected month: " + str(month), alignment=PP_ALIGN.LEFT, font_name= 'Neue Haas Grotesk Text Pro', font_size=10, font_bold=False,left=Inches(0.5), top=Inches(1.25), width=Inches(12), height=Inches(0.3), font_color=RGBColor(0, 0, 0))
...
# Add a title to the slide
	...
	format_title(ppt.slides[page_no], "selected quarter: " + str(quarter), alignment=PP_ALIGN.LEFT, font_name= 'Neue Haas Grotesk Text Pro', font_size=10, font_bold=False,left=Inches(0.5), top=Inches(1.25), width=Inches(12), height=Inches(0.3), font_color=RGBColor(0, 0, 0))
...
# Calculate SOV
	...
	SOV = np.ceil((loreal_views/total_views) * 1000) / 1000
# Calculate SOC
	loreal_content = loreal_df['content'].sum()
	total_content = df_y['content'].sum()
	SOC = np.ceil((loreal_content/total_content) * 1000) / 1000
# Calculate SOE
	loreal_eng = loreal_df['engagements'].sum()
	total_eng = df_y['engagements'].sum()
	SOE = np.ceil((loreal_eng/total_eng) * 1000) / 1000
# Calculate SOI
	SOI = (SOV + SOC + SOE)/3
...
#-----------PAGE 17---------------
	...
	format_title(ppt.slides[page_no], "(based on Engagement)", alignment=PP_ALIGN.CENTER, font_name='Montserrat', font_size=12, font_bold=False, font_italic = True,
		     left=Inches(0.5), top=Inches(1.8), width=Inches(6), height=Inches(0.5), font_color=RGBColor(0, 0, 0))
	...
	format_title(ppt.slides[page_no], "(based on actual views)", alignment=PP_ALIGN.CENTER, font_name='Montserrat', font_size=12, font_bold=False, font_italic = True,
		     left=Inches(6.5), top=Inches(1.8), width=Inches(6), height=Inches(0.5), font_color=RGBColor(0, 0, 0))
