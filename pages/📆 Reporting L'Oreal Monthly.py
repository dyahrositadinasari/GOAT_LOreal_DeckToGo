...
#------------PAGE 12--------------
	...
	df_12['category'] = pd.Series(pd.factorize(df_12['category'])[0]).astype(str) + '_' + df_12['category']
	#df_12['category'] = df_12['category'].where(df_12['category'].duplicated(), df_12['category'] + '_' + df_12.groupby('category').cumcount().astype(str))
